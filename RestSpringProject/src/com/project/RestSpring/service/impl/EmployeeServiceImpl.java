...
public class EmployeeServiceImpl implements EmployeeService{
	...
	public boolean savePerson(HashMap<String, Object> map) {
		...
		return empdao.SaveObj(personModel);
	}

	@Override
	public boolean savePersonVO(PersonVO personVO) {
		PersonModel personModel=ConvertVoToBean.setPersonVoToBean(personVO);
		return empdao.SaveObj(personModel);
	}

	@Override
	public boolean saveBankVO(BankVO bankVO) {
		BankModel bankmodel=ConvertVoToBean.setBankVOToBankBean(bankVO);
		return empdao.SaveObj(bankmodel);
	}
}
